...
class viajesContralador
{
    ...
    public function agregarViaje()
    {
        if ($this->autenticar->verificarSecion()) {
            if (
                !isset($_POST['destino_inicio']) || empty($_POST['destino_inicio']) ||
            ...
            || $_FILES['imagen']['type'] == "image/png"){
                ...
                $this->modelo->agregarViaje($destino_inicio, $destino_fin, $fecha_salida, $precio, $id_pasajero, $_FILES['imagen']['tmp_name']);
            }
            else{
                $this->modelo->agregarViaje($destino_inicio, $destino_fin, $fecha_salida, $precio, $id_pasajero);
            }
    ...
    public function modificarViaje($id_viaje){
        ...
        if ($_FILES['imagen']['type'] == "image/jpg" || $_FILES['imagen']['type'] == "image/jpeg" 
            || $_FILES['imagen']['type'] == "image/png"){
                ...
                $this->modelo->editarViaje($id_viaje, $destino_inicio, $destino_fin, $fecha_salida, $precio, $id_pasajero, $_FILES['imagen']['tmp_name']);
            }
            else{
